...
import axios from "axios"; // Fixed typo: axois -> axios
    ...
    <footer className="bg-[#151921] text-gray-300 py-8 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-start">
          <div>
            <Image
              src="/logogray.png" // Ensure this path is correct
        ...
        <div className="md:col-span-1">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center md:items-start gap-2">
              ...
              <span className="text-sm">{footerData?.address || "Loading..."}</span> {/* Fixed: phone -> address */}
            </li>
          </ul>
        </div>
