...
export default function Home({ params: { lng } }: { params: { lng: string } }) {
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        setLoading(true);
        const [footerRes, designRes, portfolioRes, publicationsRes] = await Promise.all([
          axios.get('https://api.mars-architects.us/aboutus/about-us/'),
          axios.get('https://api.mars-architects.us/portfolio/interior-design/'),
          axios.get('https://api.mars-architects.us/portfolio/architectural-projects/'),
          axios.get('https://api.mars-architects.us/publications/publications/'),
        ]);
